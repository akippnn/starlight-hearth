...
| `05_SHELL_UI_SETTINGS_AND_PLUGIN_SURFACES.md` | Bar; App Menu; workspaces; clock; control center/notifications; overlay; Settings; attribution; apps; plugins | `contracts/hearth-bar.md`, `contracts/app-menu.md`, `requirements.md`, `open-questions.md`, `roadmap.md` |
...
| `07_WALLPAPER_BACKGROUND_AND_AUTOCROP.md` | Product surface; Waifu.im defaults/semantics/customization; metadata; model; deterministic crop; orientation; performance; Gaming Mode reuse | `requirements.md` (`WALL-*`), `open-questions.md` (`OQ-050`–`OQ-052`), `reuse-ledger.md`, `roadmap.md` |
...
| `11_REFERENCES_AND_RESEARCH.md` | Caelestia; DMS; M3Shapes; Clavis; niri port; Quickshell; U²-Net; Waifu.im; licensing | `reuse-ledger.md`, ADR-0006/0007, `requirements.md`, `open-questions.md` |
...
| Bar visible on hover/focus/owned-panel, edge span, 250 ms grace, focus return | `contracts/hearth-bar.md`, `requirements.md` |
