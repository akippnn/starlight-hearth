...
class ImageContractTests(unittest.TestCase):
    def test_recipe_keeps_compatibility_and_signing_order(self):
        ...
        self.assertIn(
            ...
            'releases/download/hearth-v0.3.0-rc.3/'
            'hearth-shell-0.3.0-0.3.rc3.fc44.x86_64.rpm"',
            installer,
        )
        self.assertIn(
            'readonly default_sha256="89895cc2ab05435c7496e5192132b6195892394c2e7eb44caac01b27e4cf4763"',
            installer,
        )
    ...
    def test_static_data_is_parseable_and_locked_to_v4(self):
        ...
        self.assertIn('match namespace="^hearth-launcher-drawer-xray$"', niri_rules)
        self.assertNotIn('match namespace="^hearth-launcher-drawer$"', niri_rules)
